...
A small project to show the cases of async task cancellation in Rust using [tokio](https://tokio.rs).
...
| [`select_all`](src/select_all/README.md)  | `futures::future::select_all`           | first future completes       | forced drop (developer's choice) |
